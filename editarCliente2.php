...
<div class="container">
    <div class="form-container">
        ...
        $sql = "UPDATE Clientes SET Nombre = '$nombre', Telefono = '$telefono', Email = '$email', DNI = '$dni' WHERE ID_Cliente = '$id'";
        ...
        <div class="text-center mt-5">
            ...
            <?php else: ?>
                <div class="alert alert-danger">Error al actualizar el cliente.</div>
            <?php endif; ?>
