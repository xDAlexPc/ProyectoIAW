...
<div class="container">
    <div class="form-container">
        <!-- Aquí el contenido original del archivo -->
        <?php
        ...
        <div class="text-center mt-5">
            <?php if ($resultado): ?>
                <div class="alert alert-success">Cliente registrado con éxito.</div>
            <?php else: ?>
                <div class="alert alert-danger">Error al registrar el cliente.</div>
            <?php endif; ?>
